...
return [
    ...
    */
    'attributes' => [
        ...
        'change_answers'    => 'mudar resposta',
        'social_profile'    => 'perfil social',
        'format_item'       => 'formato dos itens',
        'option_others'     => 'opção outros',
        'show_result'       => 'mostrar resultados',
        'format_result'     => 'formato de resultado',
        'expire_vote'       => 'validade de votos',
        'text_1'            => 'texto do item',
        'image_1'           => 'imagem do item',
    ],
];
